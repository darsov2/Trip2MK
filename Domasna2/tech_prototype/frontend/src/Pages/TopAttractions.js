...
const TopAttractions = () => {
    return (
        <>
            ...
            <Container>
                <h1 className="py-5 my-3">Ohrid in 2 Days - Top Attractions</h1>
            </Container>

            <Container style={{backgroundColor: "#66a792"}}>
                <h1 className={"text-start"} style={{color: "white"}}>Day 1</h1>
            </Container>
            <Attraction img={"https://live.staticflickr.com/65535/48122814791_c4c66ae523_b.jpg"} title={"St. Sofia Church"} desc={"The walk starts from the church dedicated to Christ as God's wisdom, known as St. Sophia of Ohrid. It is located in the old part of the city, i.e. in the heart of the city and is a monument of medieval Byzantine art. It is the largest painted gallery of bishops and deacons ever discovered in Eastern Orthodox and Byzantine art. Throughout history, St. Sofia, a centuries-old cathedral church of the Ohrid archdiocese, functioned as a mosque during the Turkish period, and in 1912 it regained its purpose. Today, numerous cultural events and concerts of \"Ohrid Summer\" are held in the luxurious vestibule and acoustic setting."}></Attraction>
            <DurationToDestination text={"7min walking"}></DurationToDestination>
            <Attraction img={"https://dynamic-media-cdn.tripadvisor.com/media/photo-o/13/43/91/17/received-10156460186043739.jpg?w=1200&h=-1&s=1"} title={"St. Jovan Kaneo"} desc={"On the southwestern part of the hill, on a natural platform that according to some is the most beautiful city location, right above Lake Ohrid, a church dedicated to the evangelist St. John the Theologian stands in a miraculous way. According to others, it is precisely this location of the church \"St. John the Theologian Kaneo\" that counts it among the most attractive churches in the city. Who once entered the church or, again, stopped and sat on the platform, in the most beautiful city location of Kaneo, and from there looked at the lake, the horizon or the setting sun, with the same need and love for that inner feeling of peace and humility that can hardly be described , comes back to Kaneo again and again."}></Attraction>
            <DurationToDestination text={"10min walking"}></DurationToDestination>
            <Attraction img={"https://macedonia-timeless.com/wp-content/uploads/2018/09/plaosnik-vozobnovuvanje.jpg"} title={"Plaoshnik"} desc={"The archaeological complex Plaoshnik is located on the higher Ohrid Hill between the Samoilova Tvrdina and the picturesque area of the Kaneo church. In a historical, cultural and spiritual sense, Plaoshnik is the most significant area for Macedonia and for the entire Slavic race. The most significant is precisely in this area the existence of the first Slavic university in Europe, which provides Ohrid with a prestigious name - Slavic Jerusalem."}></Attraction>
            <DurationToDestination text={"15min walking"}></DurationToDestination>
            <Attraction img={"https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Samoilova_tvrdina_juli_2016_%2834%29.JPG/1280px-Samoilova_tvrdina_juli_2016_%2834%29.JPG"} title={"Samoil's fortress"} desc={"Samoil's fortress – one of the oldest preserved fortifications. Known as Samoil's fortress, the current form of the fortress originates from the period when Ohrid was the capital of Samoil's state. During that period, Ohrid grew into a medieval metropolis, protected by high walls and towers.\n" +
